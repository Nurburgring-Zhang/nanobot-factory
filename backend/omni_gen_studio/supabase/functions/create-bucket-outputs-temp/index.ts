...
Deno.serve(async (req) => {
    ...
    bucketConfig.allowed_mime_types = ["image/*", "video/*"];
    ...
    const policyQueries = [
        ...
        `CREATE POLICY "Public Access for outputs" ON storage.objects FOR SELECT USING (bucket_id = 'outputs');`,
        // Allow public to insert objects in this bucket
        `CREATE POLICY "Public Upload for outputs" ON storage.objects FOR INSERT WITH CHECK (bucket_id = 'outputs');`,
        // Allow public to update objects in this bucket
        `CREATE POLICY "Public Update for outputs" ON storage.objects FOR UPDATE USING (bucket_id = 'outputs');`,
        // Allow public to delete objects in this bucket
        `CREATE POLICY "Public Delete for outputs" ON storage.objects FOR DELETE USING (bucket_id = 'outputs');`
    ];
