...
Deno.serve(async (req) => {
    ...
    const policyQueries = [
        ...
        `CREATE POLICY "Public Access for inputs" ON storage.objects FOR SELECT USING (bucket_id = 'inputs');`,
        // Allow public to insert objects in this bucket
        `CREATE POLICY "Public Upload for inputs" ON storage.objects FOR INSERT WITH CHECK (bucket_id = 'inputs');`,
        // Allow public to update objects in this bucket
        `CREATE POLICY "Public Update for inputs" ON storage.objects FOR UPDATE USING (bucket_id = 'inputs');`,
        // Allow public to delete objects in this bucket
        `CREATE POLICY "Public Delete for inputs" ON storage.objects FOR DELETE USING (bucket_id = 'inputs');`
    ];
