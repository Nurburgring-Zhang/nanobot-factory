...
Deno.serve(async (req) => {
    ...
    const policyQueries = [
        ...
        `CREATE POLICY "Public Upload for thumbnails" ON storage.objects FOR INSERT WITH CHECK (bucket_id = 'thumbnails');`,
        // Allow public to update objects in this bucket
        `CREATE POLICY "Public Update for thumbnails" ON storage.objects FOR UPDATE USING (bucket_id = 'thumbnails');`,
        // Allow public to delete objects in this bucket
        `CREATE POLICY "Public Delete for thumbnails" ON storage.objects FOR DELETE USING (bucket_id = 'thumbnails');`
    ];
