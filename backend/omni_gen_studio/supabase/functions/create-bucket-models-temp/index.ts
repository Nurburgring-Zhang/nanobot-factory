...
Deno.serve(async (req) => {
    ...
    bucketConfig.allowed_mime_types = ["application/zip"];
    ...
    const policyQueries = [
        ...
        `CREATE POLICY "Public Access for models" ON storage.objects FOR SELECT USING (bucket_id = 'models');`,
        // Allow public to insert objects in this bucket
        `CREATE POLICY "Public Upload for models" ON storage.objects FOR INSERT WITH CHECK (bucket_id = 'models');`,
        // Allow public to update objects in this bucket
        `CREATE POLICY "Public Update for models" ON storage.objects FOR UPDATE USING (bucket_id = 'models');`,
        // Allow public to delete objects in this bucket
        `CREATE POLICY "Public Delete for models" ON storage.objects FOR DELETE USING (bucket_id = 'models');`
    ];
