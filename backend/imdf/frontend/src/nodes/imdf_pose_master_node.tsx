 ...
 * 类型 key : pose-master
 * 组件     : PoseMasterNode
 * Data in  : NodeDataShape<'pose-master'> (用户/上游配置 + 节点自身状态)
 * Data out : imageUrl/videoUrl/audioUrl/prompt/outputText 写回 data
 * 默认值   : mergeDefaultData('pose-master', p.data) → defaults.ts
 * IO 文档   : NODE_IO_CONTRACTS → 类型 'pose-master'
...
const PoseMasterNode = (props: NodeProps) => {
  ...
  const data = mergeDefaultData('pose-master', (props.data as Partial<NodeDataShape<'pose-master'>>) || undefined) as unknown as Record<string, any>;
