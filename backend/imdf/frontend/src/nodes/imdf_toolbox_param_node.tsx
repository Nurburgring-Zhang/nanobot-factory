 ...
 * 类型 key : toolbox-param
 * 组件     : ToolboxParamNode
 * Data in  : NodeDataShape<'toolbox-param'> (用户/上游配置 + 节点自身状态)
 * Data out : imageUrl/videoUrl/audioUrl/prompt/outputText 写回 data
 * 默认值   : mergeDefaultData('toolbox-param', p.data) → defaults.ts
 * IO 文档   : NODE_IO_CONTRACTS → 类型 'toolbox-param'
...
const ToolboxParamNode = (p: NodeProps) => {
  ...
  const d = mergeDefaultData('toolbox-param', (p.data as Partial<NodeDataShape<'toolbox-param'>>) || undefined);
